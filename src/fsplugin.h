...
#define FS_CRYPT_LOAD_PASSWORD_NO_UI                                                               \
    3                            // Load password only if master password has already been entered!
...
#define BG_ASK_USER                                                                                \
    4 // Plugin requires separate connection for background transfers -> ask user first
